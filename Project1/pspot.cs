...
namespace Project1
{
    public partial class pspot : Form
    {
        ...
        private void pspot_Load(object sender, EventArgs e)
        {
            ...
            pstb1.Text = "Введите отчество клиента";
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM Клиенты WHERE Отчество LIKE '%" + Name + "%'";
