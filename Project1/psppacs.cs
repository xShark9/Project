...
namespace Project1
{
    public partial class psppacs : Form
    {
        ...
        private void psppacs_Load(object sender, EventArgs e)
        {
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            Connect.Open();
            string pasp = pstb1.Text;
            string query = "SELECT * FROM Клиенты WHERE Паспорт LIKE '%" + pasp + "%'";
