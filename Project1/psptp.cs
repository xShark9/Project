...
namespace Project1
{
    public partial class psptp : Form
    {
        ...
        private void psptp_Load(object sender, EventArgs e)
        {
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            Connect.Open();
            string tel = pstb1.Text;
            string query = "SELECT * FROM Клиенты WHERE Телефон LIKE '%" + tel + "%'";
